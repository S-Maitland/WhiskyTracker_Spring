...
public class WhiskyController {
    ...
    public List<Whisky> getWhiskiesByDistilleryAndAge
            (@PathVariable String name, @PathVariable int age){
        return whiskyRepository.whiskiesByDistilleryAndAge(name, age);
    }

    @GetMapping(value = "/region/{region}")
    public List<Whisky> allWhiskiesByRegion(@PathVariable String region){
        return whiskyRepository.whiskiesFromDistilleryRegion(region);
    }
